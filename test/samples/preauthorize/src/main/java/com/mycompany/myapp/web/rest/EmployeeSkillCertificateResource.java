...
public class EmployeeSkillCertificateResource {
    ...
    @PreAuthorize("hasAuthority('" + EMPLOYEE_SKILL_CERTIFICATE_CREATE + "')")
    ...
    @PreAuthorize("hasAuthority('" + EMPLOYEE_SKILL_CERTIFICATE_UPDATE + "')")
    ...
    @PreAuthorize("hasAuthority('" + EMPLOYEE_SKILL_CERTIFICATE_READ + "')")
    ...
    @PreAuthorize("hasAuthority('" + EMPLOYEE_SKILL_CERTIFICATE_DELETE + "')")
