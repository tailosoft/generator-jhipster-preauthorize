...
public class CertificateTypeResource {
    ...
    @PreAuthorize("hasAuthority('" + CERTIFICATE_TYPE_CREATE + "')")
    ...
    @PreAuthorize("hasAuthority('" + CERTIFICATE_TYPE_UPDATE + "')")
    ...
    @PreAuthorize("hasAuthority('" + CERTIFICATE_TYPE_READ + "')")
    ...
    @PreAuthorize("hasAuthority('" + CERTIFICATE_TYPE_DELETE + "')")
